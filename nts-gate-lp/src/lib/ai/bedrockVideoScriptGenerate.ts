...

{
  ...
  "narration_text": "全セクションのナレーションをつなげた完全なテキスト（後述の 6 セクション分）",
  "sections": [
    {
      "heading": "イントロ",
      "text": "補助金名と概要を 2〜3 文で紹介。視聴者に『自分ごと』として届ける書き出し。120〜180 字。",
      "duration_sec": 15
    },
    {
      "heading": "こんな課題を持つ経営者に",
      "text": "対象となる経営者の課題を 2〜3 点、具体的に語りかける。150〜200 字。",
      "duration_sec": 20
    },
    {
      "heading": "この補助金でできること",
      "text": "補助金の内容・補助額・補助率を平易な言葉で説明。不明な場合は『公募要領で要確認』と述べる。200〜280 字。",
      "duration_sec": 30
    },
    {
      "heading": "活用例",
      "text": "仮想の活用シーンを 1〜2 件紹介。必ず冒頭に『例えば、』を付ける。実際の採択事例ではないことを示す。180〜240 字。",
      "duration_sec": 25
    },
    {
      "heading": "申請のポイント",
      "text": "申請前に確認すべき注意点を 2〜3 点。締め切り・要件チェック・計画書の重要性など。160〜210 字。",
      "duration_sec": 20
    },
    {
      "heading": "NTS へのご相談",
      "text": "補助金活用の戦略設計について NTS に相談できることを案内。申請代行ではなく戦略設計・伴走支援として伝える。80〜120 字。",
      "duration_sec": 10
    }
  ],
