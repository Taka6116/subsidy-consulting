...
import { generalSubsidy as data } from "@/lib/subsidy-data/general-subsidy";

export const metadata: Metadata = {
  title: "中小企業賃上げ・経営強化補助金 最大300万円 | NTS補助金サポート",
  description:
    "中小企業の賃上げ環境整備・経営強化を支援する補助金の活用ポイントを整理。人材確保・定着・生産性向上を国の支援で実現するための相談を受け付けています。",
};

export default function WageSupportLP() {
  return (
    <>
      <Header />
