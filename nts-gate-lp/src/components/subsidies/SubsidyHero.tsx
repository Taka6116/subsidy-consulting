...
export default function SubsidyHero({ counts, activePrefectureCount }: { counts: Counts; activePrefectureCount: number }) {
  return (
    ...
    >
      ...
      {/* ══ HERO ══ */}
      <section className="relative z-10 mx-auto w-full max-w-[1280px] px-0 pb-10 pt-20 md:pt-22 lg:pt-16">
        <div className="grid items-center gap-6 lg:grid-cols-[340px_1fr_296px] lg:gap-6 xl:grid-cols-[360px_1fr_316px] xl:gap-8">
          ...
          <motion.div
            ...
            className="relative h-[440px] overflow-visible md:h-[500px] lg:h-[540px] xl:h-[540px]"
          >
            {/* 補助金公募中都道府県バッジ：地図左上 */}
        ...
        <div className="relative z-10 -mt-28 grid gap-3 md:grid-cols-3 lg:-mt-24 lg:grid-cols-3 lg:pr-[328px] lg:pl-6 xl:pr-[348px]">
          {FEATURES.map((f, i) => (
            <motion.div
              key={f.title}
