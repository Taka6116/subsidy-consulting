...
const subsidies: Subsidy[] = [
  {
    name: "中小企業成長加速化補助金",
    max: "最大5億円",
    body: "製造業・サービス業など幅広い中小企業の成長投資を支援。設備導入や新事業展開、海外展開など、事業拡大に向けた取り組みに活用できます。IT・製造業・各種ベンダーのお客様に提案しやすい補助金です。",
    fit: "幅広い業種向け",
    image: isometric15,
  ...
  },
  {
    name: "小規模事業者持続化補助金",
    max: "最大9,000万円",
    body: "小規模事業者の販路開拓・業務効率化を支援する補助金。比較的幅広い小規模事業者が対象で、提案しやすい入門的な補助金です。",
